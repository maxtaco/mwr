...
(function() {
  ...
  Runner = (function() {
      ...
      (function(_this) {
        ...
        return function() {
          (function(__iced_k) {
            ...
            _this.stage(_this._filename, esc(__iced_deferrals.defer({
              lineno: 79
            })));
            __iced_deferrals._fulfill();
          })(function() {
    ...
    Runner.prototype.stage = function(fn, cb) {
      ...
      (function(_this) {
        ...
        return function() {
          (function(__iced_k) {
            ...
            _this.stage(_this._dir_sign_file, esc(__iced_deferrals.defer({
              lineno: 178
            })));
            __iced_deferrals._fulfill();
          })(function() {
