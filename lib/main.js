...
(function() {
  ...
  Runner = (function() {
      ...
      (function(_this) {
        ...
        return function() {
          (function(__iced_k) {
            ...
            _this._new_version_vs = "v" + _this._new_version_s;
            return cb(null);
          });
        };
      })(this));
    ...
    Runner.prototype.commit = function(fn, cb) {
      var args, err, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      args = ["commit", "-m", this._new_version_vs, fn];
      (function(_this) {
        return (function(__iced_k) {
          __iced_deferrals = new iced.Deferrals(__iced_k, {
            parent: ___iced_passed_deferral,
      ...
      (function(_this) {
        ...
        return function() {
          (function(__iced_k) {
            ...
            _this.commit(_this._dir_sign_file, esc(__iced_deferrals.defer({
              lineno: 170
            })));
            __iced_deferrals._fulfill();
          })(function() {
                    ...
                    (function(__iced_k) {
                      ...
                      (function(__iced_k) {
                        ...
                        (function(__iced_k) {
                          ...
                          _this.commit(_this._filename, esc(__iced_deferrals.defer({
                            lineno: 209
                          })));
                          __iced_deferrals._fulfill();
                        })(function() {
