...
(function() {
  var Child, Runner, a_json_parse, fs, iced, iutils, make_esc, parse_args, read, semver, spawn, __iced_k, __iced_k_noop, _ref;
  ...
  Runner = (function() {
    ...
    Runner.prototype.select_key = function(cb) {
      var err, _ref1, _ref2;
      err = null;
      this._key = !this.argv.key || this.argv.key.length === 0 ? null : (_ref1 = this.argv.key) === "1" || _ref1 === "keybase" || _ref1 === "kb" || _ref1 === "code" ? "code@keybase.io" : (_ref2 = this.argv.key) === "2" || _ref2 === "themax" || _ref2 === "max" || _ref2 === "me" || _ref2 === "gmail" ? "themax@gmail.com" : (err = new Error("don't recognize this key: " + this.argv.key), null);
      return cb(err);
    };
